...
let s:violet = {"gui": "#D787FF", "cterm": "177", "cterm16": "13"}
...
call s:h("Statement", { "fg": s:violet }) " any statement
call s:h("Conditional", { "fg": s:violet }) " if, then, else, endif, switch, etc.
...
call s:h("Include", { "fg": s:violet }) " preprocessor #include
call s:h("Define", { "fg": s:violet }) " preprocessor #define
call s:h("Macro", { "fg": s:violet }) " same as Define
...
call s:h("Todo", { "fg": s:violet }) " anything that needs extra attention; mostly the keywords TODO FIXME and XXX
...
call s:h("pythonOperator", { "fg": s:violet })
